(function () {
  ...
  if (!root) {
    ...
    host.innerHTML = [
      ...
      '<p class="hz-whatsapp__note">Educational content. Currently no charge to subscribe. Fees may be introduced later with notice. Unsubscribe anytime. We don\'t sell your data.</p>',
      '</section></div></div>'
    ].join("");
